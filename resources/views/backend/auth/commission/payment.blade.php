        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    {{ __('labels.backend.access.commission.management') }} <small class="text-muted">{{ __('labels.backend.access.commission.payment') }}</small>
                </h4>
            </div><!--col-->
                    ...
                    <table class="table">
                        ...
                        @foreach ($commission as $user)
                            <tr>
                                ...
                                <td>{{ $user->email }}</td>
                                <td>{{ $user->amount }}</td>
                                <td> <a href="{{route('admin.auth.commission.paymented',$user)}}" class="btn btn-primary"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="Completed?"></i></a></td>
                            </tr>
                        @endforeach
                        @else
