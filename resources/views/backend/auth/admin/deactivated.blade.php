...
@section ('title', __('labels.backend.access.admins.management') . ' | ' . __('labels.backend.access.admins.deactivated'))
        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    ...
                    <small class="text-muted">{{ __('labels.backend.access.admins.deactivated') }}</small>
                </h4>
            </div><!--col-->
        </div><!--row-->
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        @if ($admins->count())
                            ...
                            @endforeach
                        @else
                            <tr><td colspan="9"><p class="text-center">{{ __('strings.backend.access.admins.no_deactivated') }}</p></td></tr>
                        @endif
                        </tbody>
                    </table>
                </div>
