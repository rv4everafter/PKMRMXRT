...
@section ('title', __('labels.backend.access.admins.management') . ' | ' . __('labels.backend.access.admins.create'))
...
@section('content')
    {{ html()->form('POST', route('admin.auth.admin.store'))->class('form-horizontal')->open() }}
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-5">
                        <h4 class="card-title mb-0">
                            ...
                            <small class="text-muted">{{ __('labels.backend.access.admins.create') }}</small>
                        </h4>
                    </div><!--col-->
                </div><!--row-->
                ...
                <div class="row mt-4 mb-4">
                    <div class="col">
                        ...
                        <div class="form-group row">
                            {{ html()->label(__('validation.attributes.backend.access.admins.password'))->class('col-md-2 form-control-label')->for('password') }}

                            <div class="col-md-10">
                                {{ html()->password('password')
                                    ->class('form-control')
                                    ->placeholder(__('validation.attributes.backend.access.admins.password'))
                                    ->required() }}
                            </div><!--col-->
                        </div><!--form-group-->

                        <div class="form-group row">
                            {{ html()->label(__('validation.attributes.backend.access.admins.password_confirmation'))->class('col-md-2 form-control-label')->for('password_confirmation') }}

                            <div class="col-md-10">
                                {{ html()->password('password_confirmation')
                                    ->class('form-control')
                                    ->placeholder(__('validation.attributes.backend.access.admins.password_confirmation'))
                                    ->required() }}
                            </div><!--col-->
                        </div><!--form-group-->
                        ...
                        <div class="form-group row">
                            {{ html()->label(__('validation.attributes.backend.access.admins.active'))->class('col-md-2 form-control-label')->for('active') }}
                        ...
                        <div class="form-group row">
                            {{ html()->label(__('validation.attributes.backend.access.admins.confirmed'))->class('col-md-2 form-control-label')->for('confirmed') }}
                        ...
                        @if (! config('access.admins.requires_approval'))
                            <div class="form-group row">
                                {{ html()->label(__('validation.attributes.backend.access.admins.send_confirmation_email') . '<br/>' . '<small>' .  __('strings.backend.access.admins.if_confirmed_off') . '</small>')->class('col-md-2 form-control-label')->for('confirmation_email') }}
