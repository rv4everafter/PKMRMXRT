...
return [
    ...
    */
    ...
    'backend' => [
        ...
        'welcome' => '<p>هذا هو ثيم rv4ever المصمم من قبل <a href="http://rv4ever.com" target="_blank">rv4ever</a>. هذه مجرد نسخة جردت من الكثير من الأشياء وتركت فقط ال Styles وال Scripts التي تجعلها تعمل بأقل الإمكانيات. يجب عليك تحميل النسخة الكاملة حتى تستطيع إضافة المكونات للوحة تحكمك.
</p>
...
<p>أتمنى أن تستمع بالمجهود الذي بذلته في هذا العمل. الرجاء زيارة صفحة <a href="https://github.com/rv4ever/tnbonce" target="_blank">GitHub</a> للمزيد من المعلومات أو <a href="https://github.com/rv4ever/tnbonce/issues" target="_blank">الإبلاغ عن الأخطاء أو المشاكل</a>.</p>
