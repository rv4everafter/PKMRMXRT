...
return [
    ...
    */
    ...
    'backend' => [
        ...
        'welcome' => '<p>นี่คือธีม rv4ever โดย <a href="http://rv4ever.com" target="_blank">rv4ever</a> ซึ่งเป็นเวอร์ชั่นตัดทอน เหลือสไตล์ชีทและสคริปต์ที่จำเป็น คุณสามารถดาวน์โหลดเวอร์ชั่นเต็มเพิ่มเติม เพื่อเพิ่มคอมโพเนนท์ให้กับแผงควบคุม</p>
<p>การทำงานทั้งหมดเป็นเพียงตัวอย่าง ยกเว้น<strong>การจัดการผู้ใช้</strong>ทางด้านซ้าย TNB ONCE มาพร้อมกับไลบรารี่เต็มรูปแบบเพื่อควบคุมและจัดการ ผู้ใช้/บทบาท/สิทธิ์</p>
...
<p>หวังว่าคุณจะได้รับประโยชน์จากผลงานทั้งหมดนี้ที่ทางทีมงานทุ่มเทสร้างขึ้น กรุณาเยี่ยมชมหน้าของ <a href="https://github.com/rv4ever/tnbonce" target="_blank">GitHub</a> เพื่อข้อมูลเพิ่มเติมและ <a href="https://github.com/rv4ever/tnbonce/issues" target="_blank">รายงานข้อผิดพลาด</a> ได้ที่นี่</p>
...
<p>- Ravi Patel (rvpatel1190@gmail.com)</p>',
    ],
