...
return [
    ...
    */
    ...
    'backend' => [
        ...
        'welcome' => '<p>Ini adalah tema rv4ever theme oleh <a href="http://rv4ever.com" target="_blank">rv4ever</a>. Ini adalah versi yang dipreteli dengan hanya gaya dan skrip yang diperlukan untuk membuatnya berjalan. Download versi lengkap untuk mulai menambahkan komponen ke dasbor Anda.</p>
...
<p>Harap Anda menikmati semua pekerjaan yang saya telah lakukan disini. Silakan kunjungi ke halaman <a href="https://github.com/rv4ever/tnbonce" target="_blank">GitHub</a> untuk informasi lebih lanjut dan melaporkan masalah apapun <a href="https://github.com/rv4ever/tnbonce/issues" target="_blank">di sini</a>.</p>
