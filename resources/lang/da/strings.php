...
return [
    ...
    */
    ...
    'backend' => [
        ...
        'welcome' => '<p>Dette er temaet rv4ever som er udviklet af <a href="http://rv4ever.com" target="_blank">rv4ever</a>. Dette er en skrabet udgave med kun det nødvendige design og kode for at få det hele til at fungere. Download den fulde version for at tilføje flere komponenter til dit betjeningspanel.</p>
...
<p>Håber at du er glad for indsatsen jeg har givet dette projekt. Du er velkommen til at besøge os på <a href="https://github.com/rv4ever/tnbonce" target="_blank">GitHub</a> for mere information og du kan samtidig med indberette <a href="https://github.com/rv4ever/tnbonce/issues" target="_blank">fejl her</a>.</p>
