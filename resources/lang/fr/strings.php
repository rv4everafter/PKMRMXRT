...
return [
    ...
    */
    ...
    'backend' => [
        ...
        'welcome' => '<p>Le thème rv4ever est créé par <a href="http://rv4ever.com" target="_blank">rv4ever</a>. Ceci est une version allégée avec seulement les styles et les scripts nécessaires pour le faire fonctionner. Téléchargez la version complète pour commencer à ajouter des composants à votre tableau de bord.</p>
...
<p>J\'espère que vous apprécierez le travail que j\'ai mis dans ce projet. Visitez la page <a href="https://github.com/rv4ever/tnbonce" target="_blank">GitHub</a> pour plus d\'informations et enregistrez les <a href="https://github.com/rv4ever/tnbonce/issues" target="_blank">anomalies ici</a>.</p>
