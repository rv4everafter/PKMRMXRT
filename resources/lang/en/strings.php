    ...
    'backend' => [
        'access' => [
            'users' => [
                ...
                'no_active' => 'There are no active users.',
                'no_deleted' => 'There are no deleted users.',
                'restore_user_confirm' => 'Restore this user to its original state?',
            ],
            'admins' => [
                'delete_admin_confirm'  => 'Are you sure you want to delete this admin permanently? Anywhere in the application that references this admin\'s id will most likely error. Proceed at your own risk. This can not be un-done.',
                'if_confirmed_off'     => '(If confirmed is off)',
                'no_deactivated' => 'There are no deactivated admins.',
                'no_active' => 'There are no active admins.',
        ...
        'welcome' => '<p>Welcome To Dashboard</p>',
    ],
