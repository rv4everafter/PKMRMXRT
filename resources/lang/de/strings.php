...
return [
    ...
    */
    ...
    'backend' => [
        ...
        'welcome' => '<p>Dies ist das rv4ever theme von <a href="http://rv4ever.com" target="_blank">rv4ever</a>. Dies ist eine abgestufte Version mit nur den nötigsten Styles und Scripten, damit es läuft. Lade die Vollversion herunter, um Komponenten zum Dashboard hinzufügen zu können.</p>
...
<p>Ich hoffe, du geniesst die Arbeit, die ich hier reingesteckt habe. Bitte besuche die <a href="https://github.com/rv4ever/tnbonce" target="_blank">GitHub</a> Seite für weitere Informationen und meldet alle <a href="https://github.com/rv4ever/tnbonce/issues" target="_blank">Fehler hier</a>.</p>
