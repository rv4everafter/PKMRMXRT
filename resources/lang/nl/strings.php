...
return [
    ...
    */
    ...
    'backend' => [
        ...
        'welcome' => '<p>Dit is het rv4ever thema door <a href="http://rv4ever.com" target="_blank">rv4ever</a>. Dit is een uitgeklede versie met alleen de stijlen and scripts om het geheel draaiende te krijgen. Download de volledige versie om componenten aan het dashboard toe te voegen.</p>
...
<p>Hopelijk geniet je van alle werk dat ik hierin heb gestopt. Bezoek de <a href="https://github.com/rv4ever/tnbonce" target="_blank">GitHub</a> pagina voor meer informatie en om <a href="https://github.com/rv4ever/tnbonce/issues" target="_blank">problemen</a> te rapporteren.</p>
