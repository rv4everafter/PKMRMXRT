...
return [
    ...
    */
    ...
    'backend'  => [
        ...
        'welcome'   => '
<p>В этом проекте использована тема оформления <strong>rv4ever</strong> с минимальным набором стилей и сценариев, необходимых для его работы.</p>
<p>Используйте полную версию <strong>rv4ever</strong> шаблона по адресу <a href="http://rv4ever.com" target="_blank">rv4ever</a> и добавляйте в это приложение необходимые вам компоненты.</p>
...
<p>Заходите на <a href="https://github.com/rv4ever/tnbonce" target="_blank">GitHub</a> страницу для получения дополнительной информации, там же вы можете отавлять свои сообщения.</p>
